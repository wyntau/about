...
1. 美团配送骑手业务前端技术架构
    - 时间: 2017.2 -- NOW
    - 项目简述: 负责组内前端相关项目的技术架构工作.
    - 个人职责:
        - 组内小程序从 0 到 1 开发建设, 制定相关流程标准, 开发规范等
        - 组内小程序开发整体架构及构建系统的搭建, 以达成 monorepo 仓库管理各小程序为目标, 通过 rollup, gulp, eslint, ts 等业界常见前端工具以及自研工具配合, 搭配公司内部构建流程工具, 完成小程序 monorepo 仓库架构, 可以支持多个小程序之间的代码共享及复用, 支撑部门内多个小程序(外卖柜小程序, 外卖柜运维小程序, 换电柜小程序, 换电柜运维小程序)后期的开发和维护工作.
        - 组内 MRN(Meituan React-Native) 开发整体架构的迭代和升级, 通过收集开发同学遇到的问题, 优先从框架层面进行解决.
        - 组内全部 H5 及部分管理端的前端技术架构及构建系统开发
        - 使用 @angular-devkit/schematics 为各前端项目提供脚手架初始化能力, 方便快速进行新页面的开发
        - 组内部分小程序的开发维护工作
...
2. 高德地图迁移腾讯地图适配层工具库
    ...
    - 个人职责:
        ...
        - 适配层整体的技术架构和主要实现, 通过 seed -> loader -> lib 的加载关系, 允许用户在前端自由选择使用高德地图, 腾讯地图, 百度地图以及 Google 地图, 并具备自动降级切换能力.
        - 统筹推动部门内Web端高德地图到腾讯地图的整体迁移工作
        - 适配层的整体维护和功能补充.

3. 美团配送骑手业务前端组内稳定性保障工作
    - 时间: 2018.3 -- NOW
    - 项目简述: 负责组内前端项目的整体稳定性保障工作, 覆盖故障预防, 故障发现, 故障止损, 故障定位等阶段.
    - 个人职责:
        - 负责出现前端问题时的问题定位
        - 制定稳定性保障流程规范, 在重要节点增加卡控, 提升项目故障预防能力
        - 稳定性保障指标制定, 告警策略的配置及优化
...
4. 其他前端相关方面的工作
    - 推动骑手APP hybrid web容器的升级和迁移工作
    - 推动骑手APP 接入美团小程序 SDK, 将外卖柜小程序从小程序 + React-Native 统一到小程序技术栈下.
    - 负责配送前端骑手业务小组内整体的数据安全及隐私合规等保障工作.
...
- 一定的前端架构能力, 主导过多个复杂前端项目(Web端, 小程序, React-Native)的完整架构及技术选型.
- 熟悉原生JS及流行的前端库或框架 React, Vue, React-Native 等.
- 具备小程序以及 React-Native 开发能力.
...
- 使用过前端测试框架 Karma Mocha 及 Expect.js Should.js等, 对自动化测试等有相关使用经验 <https://github.com/wyntau/mocha-demo>
...
- 熟悉 markdown, 可熟练使用markdown进行文档编写工作
